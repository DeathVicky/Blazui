...
namespace Blazui.Component.Dom
{
    public class Element
    {
        ...
        public int ClientHeight
        {
            get
            {
                return jSRuntime.InvokeAsync<int>("getClientHeight", elementReference).GetAwaiter().GetResult();
            }
        }

        public IReadOnlyList<ElementReference> Children
        {
            get
            {
                return jSRuntime.InvokeAsync<IReadOnlyList<ElementReference>>("getChildren", elementReference).GetAwaiter().GetResult();
            }
        }
