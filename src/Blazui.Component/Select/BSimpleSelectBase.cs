...
namespace Blazui.Component.Select
{
    ...
    {
        protected ElementReference content;
        ...
        public event Func<BChangeEventArgs<BSimpleOptionBase>, Task<bool>> OnSelectingAsync;

        public event Func<BChangeEventArgs<BSimpleOptionBase>, Task> OnSelectAsync;
        public event Action OnDispose;

        [Parameter]
        public EventCallback<BChangeEventArgs<BSimpleOptionBase>> OnSelect { get; set; }

        [Parameter]
        public EventCallback<BChangeEventArgs<BSimpleOptionBase>> OnSelecting { get; set; }
        ...
        {
            var args = new BChangeEventArgs<BSimpleOptionBase>();
            args.NewValue = item;
        ...
        protected async Task OnSelectClickAsync(MouseEventArgs e)
        {
            await ToggleAsync();
        }
